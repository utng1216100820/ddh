...
public class AdapterListElement extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView location = v.findViewById(R.id.txt_location);
        ImageView imageView= v.findViewById(R.id.imv_Image);
       // ImageView imageView1 = v.findViewById(R.id.imv_detail);
        title.setText(data[i][0]);
        location.setText(data[i][1]);
        imageView.setImageResource(dataImg[i]);
       // imageView1.setImageResource(dataImg[i]);
